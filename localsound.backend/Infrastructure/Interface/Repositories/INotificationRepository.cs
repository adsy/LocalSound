...
namespace localsound.backend.Infrastructure.Interface.Repositories
{
    public interface INotificationRepository
    {
        ...
        Task<ServiceResponse<List<Notification>>> GetUserNotificationsAsync(Guid userId);
        Task<ServiceResponse<Notification>> GetUserNotificationAsync(Guid notificationId);
        Task<ServiceResponse> DeleteUserNotificationAsync(Guid userId, Guid notificationId);
    }
}
