...
namespace localsound.backend.Persistence.Migrations
{
    ...
    [Migration("20240110104432_UpdatedUniqueConstraintOnCreatorId")]
    partial class UpdatedUniqueConstraintOnCreatorId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("localsound.backend.Domain.Model.Entity.Notification", b =>
                {
                    b.HasOne("localsound.backend.Domain.Model.Entity.AppUser", "NotificationCreator")
                        .WithOne()
                        .HasForeignKey("localsound.backend.Domain.Model.Entity.Notification", "NotificationCreatorId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
