...
namespace localsound.backend.Persistence.Migrations
{
    ...
    [Migration("20240221212710_addedToBeDeletedForTrackAndTrackImage")]
    partial class addedToBeDeletedForTrackAndTrackImage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("localsound.backend.Domain.Model.Entity.ArtistTrack", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ArtistTrackId"));
                    ...
                    SqlServerKeyBuilderExtensions.IsClustered(b.HasKey("ArtistTrackId"), false);
            ...
            modelBuilder.Entity("localsound.backend.Domain.Model.Entity.ArtistTrackGenre", b =>
                {
                    ...
                    b.HasKey("ArtistTrackId", "GenreId");
            ...
            modelBuilder.Entity("localsound.backend.Domain.Model.Entity.ArtistTrackImage", b =>
                {
                    b.Property<int>("ArtistTrackImageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ArtistTrackImageId"));
                    ...
                    b.HasKey("ArtistTrackImageId");

                    SqlServerKeyBuilderExtensions.IsClustered(b.HasKey("ArtistTrackImageId"), false);
            ...
            modelBuilder.Entity("localsound.backend.Domain.Model.Entity.ArtistTrackAudioFileContent", b =>
                {
                    b.HasOne("localsound.backend.Domain.Model.Entity.ArtistTrack", "ArtistTrack")
                        .WithOne("TrackData")
                        .HasForeignKey("localsound.backend.Domain.Model.Entity.ArtistTrackAudioFileContent", "ArtistTrackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("localsound.backend.Domain.Model.Entity.ArtistTrackImageFileContent", b =>
                {
                    b.HasOne("localsound.backend.Domain.Model.Entity.ArtistTrackImage", "ArtistTrackImage")
                        .WithOne("ArtistTrackImageFileContent")
                        .HasForeignKey("localsound.backend.Domain.Model.Entity.ArtistTrackImageFileContent", "ArtistTrackImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ArtistTrackImage");
                });
            ...
            modelBuilder.Entity("localsound.backend.Domain.Model.Entity.ArtistTrackImage", b =>
                {
                    b.Navigation("ArtistTrackImageFileContent")
                        .IsRequired();
                });
